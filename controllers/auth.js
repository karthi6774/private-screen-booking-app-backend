...
function sendMailForPaymentSuccess(data) {
  ...
  transport.sendMail(mailOptions, (error, info) => {
    if (error) {
      return manualPaymentLogger.error(
        "error occured while sending payment confirmation mail",
        {
          error: `${error}`,
        }
      );
...
exports.getPendingPaymentStatus = async (req, res, next) => {
  try {
    ...
    manualPaymentLogger.error(
      "error occured while getting all orders with pending payments ",
      {
        error: `${error}`,
      }
    );
...
exports.updatePendingPaymentStatus = async (req, res, next) => {
  try {
    ...
    manualPaymentLogger.info(
      "updating pending payment and sending  a payment confirmation mail",
      {
